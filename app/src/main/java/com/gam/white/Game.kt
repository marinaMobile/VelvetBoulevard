...
class Game : AppCompatActivity(), View.OnClickListener  {
    ...
    private fun inst(): String{
        val color = arrayOf("Purple","Yellow","Blue")
        val text = arrayOf("Yes","No")
        return "${color.random()} color with ${text.random()} text"
    }

    override fun onClick(view: View) {
        val (s1, s2, s3) = arrayOf("Purple color with Yes text", "Purple color with No text", "Yellow color with Yes text")
        val (s4, s5, s6) = arrayOf("Yellow color with No text", "Blue color with Yes text", "Blue color with No text")
